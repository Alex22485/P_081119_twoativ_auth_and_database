...
public class DriverAuth extends AppCompatActivity {
        ...
        callbacks= new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                if (!refSmsNoShow.equals("Yes")){
                    ...
                    Toast.makeText(DriverAuth.this,"ожидайте sms c кодом подтверждения",Toast.LENGTH_LONG).show();
...
// МЕТОДЫ
    ...
    public void StartCripto(){
        ...
        refSecret = databaseSecret.getReference("Водители")
                .child("Cipher")
    ...
    public void QwerySecret(){
        ...
        final Query secret= FirebaseDatabase.getInstance().getReference("Водители")
                .child("Cipher")
                .child(edtPhone.getText().toString())
                .child("secretNumber")
                .orderByChild("number");
    ...
    public void getMainList(){
        ...
        // переход на GoDriver2 для регистрации данных пользователя
        GoDriver2();
    }
...
//ALERT DIALOG
    // Введите корректный номер телефона
    public void Alert0(){
        AlertDialog.Builder mAlertDialog = new AlertDialog.Builder(DriverAuth.this);
    ...
    public void Alert5(){
        ...
        mAlertDialog
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // ПОВТОРНЫЙ переход на GoDriver2 для регистрации данных водителя
                        GoDriver2();
                    }
                });
        mAlertDialog.create();
...
// ПЕРЕХОДЫ на Другие Активити
    // переход на лист регистрации данных Водителя
    public void GoDriver2() {

        Intent GoDriver2=new Intent(this,Driver2.class);
        GoDriver2.putExtra("phoneNewDriverAuth",phoneNew);
        GoDriver2.putExtra("UserToken",newToken);
        startActivity(GoDriver2);
