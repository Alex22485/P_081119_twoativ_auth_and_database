...
public class Zakaz2 extends AppCompatActivity {
    ...
    String[] array1 ={"Щорса-Аэропорт","КрасТэц-Аэропорт","Судостроительная-Аэропорт","Вавилова-Аэропорт","Северный-Аэропорт","ЖД вокзал-Аэропорт","Ветлужанка-Аэропорт"};
    String[] array2 ={"Аэропорт-Щорса","Аэропорт-КрасТэц","Аэропорт-Судостроительная","Аэропорт-Вавилова","Аэропорт-Северный","Аэропорт-ЖД вокзал","Аэропорт-Ветлужанка"};
