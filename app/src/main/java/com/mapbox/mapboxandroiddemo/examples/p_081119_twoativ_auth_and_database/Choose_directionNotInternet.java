...
public class Choose_directionNotInternet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_direction_not_internet);
    ...
    public void Update(View view){
        Intent ddd=new Intent(this,Choose_direction.class);
        startActivity(ddd);
    }
}
